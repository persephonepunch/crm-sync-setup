...
*Architecture and receipts in full: [Dark Factory Entitlement Security](https://crm-sync.dev/share/dark-factory-entitlement-security) · Delivery-side companion: [Data Layer — WordPress, Astro, Headless](https://crm-sync.dev/share/wordpress-web-components) · Setup: [CRM Sync Setup Reference](https://www.crm-sync.dev/pages/knowledge-base#setup-guide)*
