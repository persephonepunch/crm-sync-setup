...
In words: at 30M events a month the Google metered path costs about $1,032 and the Xano + Cloudflare fixed path about $103, a difference of $929. The largest single line is Workflows orchestration at about $900, priced at $0.01 per 1,000 steps. The Pub/Sub socket itself is only about $1.84, egress about $3.43 and Cloud Trace about $29.50. At 3M events the totals are about $183 against $90, and at 300k events about $99 against $90. The Cloudflare Worker, BigQuery ingest and the $85 Xano Essential plan cost the same on both paths.
